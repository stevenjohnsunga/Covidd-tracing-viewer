        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (cnt == 0)
                {
                    ...
                    sw.Close();
                    MessageBox.Show("Datas are submitted in db.txt", "Succesful", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if(cnt==1)
                {
                    StreamWriter sw = new StreamWriter(@"db1.txt");
                    cnt += 1;
                    sw.WriteLine("Name: " + textBox1.Text);
                    sw.WriteLine("Age: " + textBox2.Text);
                    sw.WriteLine("Contact: " + textBox3.Text);
                    ...
                    sw.Close();
                    MessageBox.Show("Datas are submitted in db1.txt", "Succesful", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if (cnt == 2)
                {
                    StreamWriter sw = new StreamWriter(@"db2.txt");
                    cnt += 1;
                    sw.WriteLine("Name: " + textBox1.Text);
                    sw.WriteLine("Age: " + textBox2.Text);
                    sw.WriteLine("Contact: " + textBox3.Text);
                    ...
                    sw.Close();
                    MessageBox.Show("Datas are submitted in db2.txt", "Succesful", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show("no available entry as of today! #1", "Cut OFF", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
